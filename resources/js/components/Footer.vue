<template>
    <footer class="footer bg-white">
        <div class="container">
            <p style="padding-top:15px; margin-bottom:10px; text-align:center;">
                <span class="footer-span-link">
                    <a style="margin-right:10px;" href="/faq">{{ $t('frequently_asked_questions')}}</a> | <a style="margin-right:30px;margin-left:10px; color: #009ef7;" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">{{ $t('terms') }}</a></span>           
                    <span class="footer-span-normal">{{ $t('footerWorkingTime') }} 09:00 ~ 18:00. {{ $t('footerLunchTime') }} 12:00 ~ 13:00.  {{ $t('footerRest') }}</span>
                </p>
                <hr>
