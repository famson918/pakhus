    ...
    <!--end::Brand-->
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                <div @click="hideSidebar" v-if="!authenticated" class="menu-item">
                    <router-link @click="setActiveMenuItem('log')" :class="{ active: activeMenuItem === 'log' }" to="/login" class="menu-link">
                        ...
                        <span class="menu-title fs-5">{{$t('login')}}</span>
                    </router-link>
                </div>
                <div @click="hideSidebar" class="menu-item">
                    <router-link @click="setActiveMenuItem('proposals')" :class="{ active: activeMenuItem === 'proposals' }" to="/proposals" class="menu-link">
                        ...
                        <span class="menu-title fs-5">{{$t('commissioned_services')}}</span>
                    </router-link>
                </div>
                <div  @click="hideSidebar" class="menu-item">
                ...
                <div  @click="hideSidebar"  v-if="role ==='admin'" class="menu-item">
                    <router-link @click="setActiveMenuItem('salesManager')" :class="{ active: activeMenuItem === 'salesManager' }" to="/salesManager" class="menu-link">
                        ...
                        <span class="menu-title fs-5">{{$t('salesList')}}</span>
                    </router-link>
                </div>
                <!-- <div @click="hideSidebar" class="menu-item">
                    <router-link @click="setActiveMenuItem('faq')" :class="{ active: activeMenuItem === 'faq' }" to="/admin/faq" class="menu-link" href="../../demo1/dist/dashboards/only-header.html">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div @click="hideSidebar" v-if="role === 'admin'" class="menu-item">
                    <router-link to="/users" @click="setActiveMenuItem('users')" :class="{ active: activeMenuItem === 'users' }" class="menu-link">
                        ...
                        <span class="menu-title fs-5">{{$t('userList')}}</span>
                    </router-link>
                </div>
            </div>
            <!--end::Menu-->
...
const hideSidebar = () => {
  sidebarClass.value = ''; // Remove the class when clicked
};

const isActive = ref(new Array(6).fill(false)); // Assuming you have 6 menu items, adjust the array length as needed
